<template>
  <v-card tile max-width="66vw" class="mx-auto ma-3">
    <v-col class="d-flex flex-column align-center">
      ...
      <v-card-subtitle>
        об обеспечении АРМ нового сотрудника
      </v-card-subtitle>
      <v-card-content>
        <v-card-text>
          <p>
            &nbsp;&nbsp;&nbsp;Прошу обеспечить АРМ нового сотрудника
            <span>
          ...
          <v-checkbox label="Выдать телефонный аппарат" dense hide-details></v-checkbox>
          <v-checkbox label="Допустить к принтерам общего пользования" dense hide-details></v-checkbox>
          <p class="mt-2">
            Для начальника
            <span>
              {{ curChief.department }}
...
export default {
  ...
  methods: {
    ...
    sendRequest: function () {
      ...
      this.curRequest.title = 'Заявка об обеспечении АРМ'

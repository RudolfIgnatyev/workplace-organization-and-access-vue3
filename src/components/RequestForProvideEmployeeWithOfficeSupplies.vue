      ...
      <v-card-content>
        <v-card-text class="pl-6 main-paragraph">
          ...
          <p>
            ...
            Управления Федерального казначейства по Республике Марий Эл набором канцелярских
            предметов, а также мебелью:
          </p>
          <v-checkbox label="Стол" dense hide-details></v-checkbox>
          <v-checkbox label="Офисное кресло" dense hide-details></v-checkbox>
          <v-checkbox label="Тумба" dense hide-details></v-checkbox>
          <p class="mt-2">
            Для начальника
            <span>
              {{ curChief.department }}
...
export default {
  ...
  methods: {
    ...
    sendRequest: function () {
      ...
      this.curRequest.title = 'Заявка на обеспечение канцелярскими товарами и мебелью'

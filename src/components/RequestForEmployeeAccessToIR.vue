      ...
      <v-card-content>
        <v-card-text>
          ...
          <p>
            ...
            Управления Федерального казначейства по Республике Марий Эл к информационным ресурсам АС Управления и
            включить его в группы:
          </p>
...
export default {
  ...
  methods: {
    ...
    sendRequest: function () {
      ...
      this.curRequest.title = 'Заявка на доступ к ИР'
